...
function Contacts() {
  ...
  const textColor= theme.type=="light"?"text-black":"text-white"
                ...
                <input
                  ...
                  className={`${styles.formInput}  
                                    border-2 border-[#8B98A5] 
                                     ${textColor} font-medium transition 
                                     focus:border-[#1D9BF0]`}
            ...
            >
              <div
                className={`w-[45px] h-[45px] 
                            ...
                            ease-in-out text-[#2c3c4c] bg-[#8B98A5]
                             hover:bg-[#1D9BF0] hover:scale-[1.1] 
                             shrink delay-200 ${bglabel}`}
              >
                <FiAtSign />
              </div>
